...
class Yytoken {
	...
	private final static String[] reglas = {
	        "axioma -> listaSent EOF",				// 0 (lineas)
	        "listaSent -> sent listaSent",			// 1	
	        "listaSent ->",							// 2	
	        "sent -> WHILE AP cond CP sent",		// 3
	        "sent -> DO sent WHILE AP cond CP PYC",	// 4
	        "sent -> IDENT IGUAL var PYC",			// 5
	        "sent -> ALL listaSent CLL", 			// 6
	        "cond -> var MENOR var",				// 7
	        "var -> IDENT",							// 8
	        "var -> NUMERO"							// 9
	};
