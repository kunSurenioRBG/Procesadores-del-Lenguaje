...
public class parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\016\000\004\011\005\001\002\000\006\002\020\011" +
    "\005\001\002\000\006\007\015\010\014\001\002\000\006" +
    "\004\010\005\011\001\002\000\006\002\uffff\011\uffff\001" +
    "\002\000\004\006\013\001\002\000\004\006\012\001\002" +
    "\000\006\002\ufffd\011\ufffd\001\002\000\006\002\ufffe\011" +
    "\ufffe\001\002\000\006\004\ufffb\005\ufffb\001\002\000\004" +
    "\011\005\001\002\000\006\004\ufffc\005\ufffc\001\002\000" +
    "\006\002\001\011\001\001\002\000\004\002\000\001\002" +
    "" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\016\000\010\002\003\003\006\004\005\001\001\000" +
    "\006\003\016\004\005\001\001\000\002\001\001\000\002" +
      ...
      switch (CUP$parser$act_num)
		...
		String v = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 RESULT = "int " + v + ";"; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // valores ::= IDENT COMA valores 
            {
              String RESULT =null;
		...
		String res = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = n + ", " + res; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("valores",2, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // valores ::= IDENT DP 
            {
              String RESULT =null;
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = n; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("valores",2, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
